...
class MainFragment : Fragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        dataList.add(FeedData(FeedCellType.COLLAB_WAITING_FEED))
        dataList.add(FeedData(FeedCellType.REPOST_FEED))
        dataList.add(FeedData(FeedCellType.CUSTOM_REPOST_FEED))
